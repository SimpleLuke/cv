...
## <a name="projects">Project Highlights 👨‍💻</a>
...
| [Clothing E-commerce Platform](https://github.com/SimpleLuke/crwn-clothing)               | Built an E-commerce website using React, Redux, and Styled-Components. Integrated Stripe for payment and Firebase for data management and authentication. | [Link](https://singular-semifreddo-6e1625.netlify.app/)                                         | JavaScript, React,React Router, Redux, Styled-Components,Stripe API,Firebase authentication and Firestore |
| [Smart Brain Face Recognition App](https://github.com/SimpleLuke/FaceRecognitionFrontEnd) | Created a face recognition app using React, Node.js, Express.js, and PostgreSQL. Users can post an image link to identify faces on the picture.           | [Code](https://github.com/SimpleLuke/FaceRecognitionFrontEnd)                                   | React, Node.js, Express.js, REST API, PostgreSQL                                                          |
| [Personal website](https://lukelai.tech)                                                  | Designed and built a personal website showcasing completed projects.                                                                                      | [Link](https://lukelai.tech)                                                                    | JavaScript, HTML, CSS, Sass, Netlify                                                                      |
...
- Developed three minimum viable products within two weeks time frame for each project, utilising various technologies such as Ruby, Sinatra, Active Record, React, Express, Node.js, MongoDB, and PostgreSQL
- Collaborated with diverse teams of software developers to deliver high-quality results and receive constructive feedback
- Demonstrated a growth mindset, strong problem-solving skills, and the ability to work under pressure in a fast-paced learning environment

#### [Zero To Mastery](https://zerotomastery.io/) September 2022 to Current
...
- [Bachelor of Fine Arts (Honours) in Drama](https://www.hkapa.edu/drama/study-programmes/bachelor-of-fine-arts-honours-in-drama), with a focus on honing skills in logical thinking and creative problem-solving
- Participated in multiple productions, showcasing strong teamwork and collaboration skills
- Received Best Actor Award for graduation production
...
- 💻 **Getting involved in the tech scene**: Writing [tech blogs](https://medium.com/@lukelai.dev) and attending events in a variety of tech groups and meetups, eg. [Codebar](https://codebar.io/)
