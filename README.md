...
| [Clothing E-commerce Platform](https://github.com/SimpleLuke/e-commerce)               | Built an E-commerce website using TypeScript, React, Redux, and Tailwind. Integrated Firebase for data management and authentication. | [Live Demo](https://subtle-bublanina-76bf5e.netlify.app/)                                         | TypeScript, React, React Router, Redux, Firebase authentication and Firestore |
...
- 💻 **Getting involved in the tech scene**: Makers Academy Alumni Meetup Organiser and attending events in a variety of tech groups and meetups, eg. [Codebar](https://codebar.io/)
